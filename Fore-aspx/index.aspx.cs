...
public partial class index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sqlSelect = String.Format("select top 5 Gno,Gname,Gimage1,Gprice from Goods where Gsort='西式蛋糕'");
        string sqlSelect2 = String.Format("select top 5 Gno,Gname,Gimage1,Gprice from Goods where Gsort='西式甜点'");
    ...
    protected void LinkButtonDelete2_Click(object sender, EventArgs e)
    {
        string gno = (((LinkButton)sender).CommandArgument.ToString()).ToString();
        Response.Redirect("good-infor.aspx?gno=" + gno);
    }
    ...
    {
        string search = Request["sousuo_text"];
        Session["SearchText"] = search;
        Response.Redirect("search.aspx?SearchText=" + search);
    }
